...
ggsave(fig_path("within_subject_change_publication.png"), p_within_subject, 
       width = 12, height = 4.5, dpi = 600, bg = "white")
...
ggsave(
  filename = here::here("Analysis", "Figures", "violin_refinedSim_ideaQuality_ownership_by_condition.png"),
...
# Save violin plots
ggplot2::ggsave(
  filename = here::here("Analysis", "Figures", "violin_cognitive_workload_by_condition.png"),
...
ggplot2::ggsave(
  filename = here::here("Analysis", "Figures", "bar_cognitive_workload_creativeSE_by_condition.png"),
...
# Create the UX spider/radar chart - CHI publication ready
png(fig_path("ux_measures_spider_chart.png"), width = 10, height = 8, units = "in", res = 300)

# Set up the plot area with professional margins for publication
...
# Also create PDF version for CHI publication (vector graphics for LaTeX)
